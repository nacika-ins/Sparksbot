...
def main():
    ...
    ngurl = re.compile(r"(kabumatome\.doorblog\.jp|otanews\.livedoor\.biz/|www\.tokuteishimasuta\.com|chaos2ch\.com|blog\.livedoor\.jp/nwknews|nureinu\.net|football-2ch\.com|blog\.livedoor\.jp/kinisoku|blog\.livedoor\.jp/himasoku123|honwaka2ch\.livedoor\.biz)")
